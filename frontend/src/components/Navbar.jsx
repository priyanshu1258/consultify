  ...
  return (
    <nav className="absolute top-0 w-full z-50 bg-transparent border-b border-white/10">
      <div className="container mx-auto px-6 py-5 flex justify-between items-center">
        <Link to="/" className="text-2xl font-bold text-white tracking-tight">Consultify<span className="text-pink-500">.</span></Link>
        <div className="hidden md:flex space-x-8 items-center">
          ...
          {user ? (
            <>
              <Link to="/dashboard" className="text-sm font-medium text-white/80 hover:text-white transition uppercase tracking-wider">Dashboard</Link>
